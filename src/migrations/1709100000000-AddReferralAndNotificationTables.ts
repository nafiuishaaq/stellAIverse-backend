...
export class AddReferralAndNotificationTables1709100000000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE referral_events DROP CONSTRAINT "FK_REFERRAL_EVENTS_REFERRAL"`);
    await queryRunner.query(`ALTER TABLE referrals DROP CONSTRAINT "FK_REFERRALS_REFEREE"`);
