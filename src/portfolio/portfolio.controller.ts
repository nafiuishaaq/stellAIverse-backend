...
export class PortfolioController {
  ...
  async updateAssetPrice(
    ...
    return this.portfolioService.updateAssetPrice(
      assetId,
      body.price,
    );
  }
  ...
  async runOptimization(
    ...
    return this.portfolioService.runOptimization(
      portfolioId,
      dto,
    );
  }
  ...
  async approveOptimization(
    ...
    return this.portfolioService.approveOptimization(
      optimizationId,
      dto.notes,
    );
  }
  ...
  async implementOptimization(
    ...
    return this.portfolioService.implementOptimization(
      optimizationId,
    );
  }
  ...
  async getOptimizationHistory(
    ...
    return this.portfolioService.getOptimizationHistory(
      portfolioId,
      limit,
    );
  }
  ...
  async checkRebalancing(
    ...
    const needed =
      await this.rebalancingService.checkRebalancingNeeded(
        portfolioId,
      );
    const drift =
      await this.rebalancingService.calculateAllocationDrift(
        portfolioId,
      );
  ...
  async approveRebalancing(
    ...
    return this.rebalancingService.approveRebalancing(
      rebalancingId,
    );
  }
  ...
  async getRebalancingHistory(
    ...
    return this.rebalancingService.getRebalancingHistory(
      portfolioId,
      limit,
    );
  }
  ...
  @Get(
    'portfolios/:portfolioId/allocation-drift',
  )
  @ApiOperation({
    summary: 'Get current allocation drift from target',
  })
  async getAllocationDrift(
    @Param('portfolioId') portfolioId: string,
  ) {
    return this.rebalancingService.calculateAllocationDrift(
      portfolioId,
    );
  }
  ...
  async getUserBacktests(
    ...
    return this.backtestService.getUserBacktests(
      req.user.id,
      limit,
    );
  }
  ...
  async compareBacktests(
    @Body() body: { backtestIds: string[] },
  ) {
    return this.backtestService.compareBacktests(
      body.backtestIds,
    );
  }
  ...
  async trainPredictor(
    ...
    return this.mlService.trainAssetPredictor(
      ticker,
