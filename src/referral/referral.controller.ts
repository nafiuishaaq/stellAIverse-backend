...
export class ReferralController {
  ...
  @ApiResponse({
    status: 403,
    description: "Rate limit exceeded or maximum codes reached",
  })
  ...
  @ApiResponse({
    status: 403,
    description: "Referral code expired or already claimed",
  })
  ...
  async suspendReferral(
    ...
    return this.referralService.suspendReferral(
      id,
  ...
  @ApiResponse({
    status: 200,
    description: "Referral reactivated successfully",
  })
  @ApiResponse({ status: 404, description: "Referral not found" })
